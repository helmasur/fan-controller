...
#define LED_D4_SetPushPull()    do { ODCONAbits.ODA5 = 1; } while(0)
#define LED_D4_SetOpenDrain()   do { ODCONAbits.ODA5 = 0; } while(0)
...
#define POT_SetPushPull()    do { ODCONCbits.ODC0 = 1; } while(0)
#define POT_SetOpenDrain()   do { ODCONCbits.ODC0 = 0; } while(0)
#define POT_SetAnalogMode()  do { ANSELCbits.ANSC0 = 1; } while(0)
#define POT_SetDigitalMode() do { ANSELCbits.ANSC0 = 0; } while(0)

// get/set NTC aliases
#define NTC_TRIS               TRISCbits.TRISC1
#define NTC_LAT                LATCbits.LATC1
#define NTC_PORT               PORTCbits.RC1
#define NTC_WPU                WPUCbits.WPUC1
#define NTC_OD                ODCONCbits.ODC1
#define NTC_ANS                ANSELCbits.ANSC1
#define NTC_SetHigh()            do { LATCbits.LATC1 = 1; } while(0)
#define NTC_SetLow()             do { LATCbits.LATC1 = 0; } while(0)
#define NTC_Toggle()             do { LATCbits.LATC1 = ~LATCbits.LATC1; } while(0)
#define NTC_GetValue()           PORTCbits.RC1
#define NTC_SetDigitalInput()    do { TRISCbits.TRISC1 = 1; } while(0)
#define NTC_SetDigitalOutput()   do { TRISCbits.TRISC1 = 0; } while(0)
#define NTC_SetPullup()      do { WPUCbits.WPUC1 = 1; } while(0)
#define NTC_ResetPullup()    do { WPUCbits.WPUC1 = 0; } while(0)
#define NTC_SetPushPull()    do { ODCONCbits.ODC1 = 1; } while(0)
#define NTC_SetOpenDrain()   do { ODCONCbits.ODC1 = 0; } while(0)
#define NTC_SetAnalogMode()  do { ANSELCbits.ANSC1 = 1; } while(0)
#define NTC_SetDigitalMode() do { ANSELCbits.ANSC1 = 0; } while(0)
...
#define IO_RC2_SetPushPull()    do { ODCONCbits.ODC2 = 1; } while(0)
#define IO_RC2_SetOpenDrain()   do { ODCONCbits.ODC2 = 0; } while(0)
...
#define IO_RC3_SetPushPull()    do { ODCONCbits.ODC3 = 1; } while(0)
#define IO_RC3_SetOpenDrain()   do { ODCONCbits.ODC3 = 0; } while(0)
...
#define SWITCH_OD                ODCONCbits.ODC4
...
#define SWITCH_SetPushPull()    do { ODCONCbits.ODC4 = 1; } while(0)
#define SWITCH_SetOpenDrain()   do { ODCONCbits.ODC4 = 0; } while(0)
...
#define IO_RC6_SetPushPull()    do { ODCONCbits.ODC6 = 1; } while(0)
#define IO_RC6_SetOpenDrain()   do { ODCONCbits.ODC6 = 0; } while(0)
...
#define IO_RC7_SetPushPull()    do { ODCONCbits.ODC7 = 1; } while(0)
#define IO_RC7_SetOpenDrain()   do { ODCONCbits.ODC7 = 0; } while(0)
